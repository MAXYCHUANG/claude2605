...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| NVDA | 核心 AI call momentum | 215.33 | NA | 0.460 | 0.773 | 37.0% | NA | NA | NA | NA |  |
| TSM | 核心供應鏈高位避險 | 404.52 | NA | 1.713 | 2.385 | 41.9% | NA | NA | NA | NA | 警示：PCR volume > 1.5，短線 put demand 明顯<br>警示：PCR OI > 1.5，存量避險或 bearish 部位偏重 |
| SMH | 半導體 ETF 高位避險 | 576.32 | NA | 1.143 | 2.767 | 44.5% | NA | NA | NA | NA | 警示：PCR OI > 1.5，存量避險或 bearish 部位偏重 |
| AMD | Momentum + call exposure | 467.51 | NA | 1.012 | 0.957 | 67.0% | NA | NA | NA | NA | 警示：IV >= 60%，波動偏高 |
| INTC | 高風險轉機 squeeze | 119.84 | NA | 1.184 | 1.066 | 78.9% | NA | NA | NA | NA | 警示：IV >= 60%，波動偏高 |
| MU | 強基本面 + peak-cycle 疑慮 | 751.00 | NA | 1.211 | 1.143 | 85.2% | NA | NA | NA | NA | 警示：IV >= 80%，市場定價極高波動 |

## 3. Futures / ETF Context

| 標的 | 價格 | 日變化 | 52 週高 | 資料源 |
|---|---:|---:|---:|---|
| QQQ | 717.54 | -0.07% | NA | Stooq |
| SOXX | 537.33 | 1.02% | NA | Stooq |
| NQ=F | NA | NA | NA | Yahoo |
| ES=F | NA | NA | NA | Yahoo |
| ^VIX | NA | NA | NA | Yahoo |
