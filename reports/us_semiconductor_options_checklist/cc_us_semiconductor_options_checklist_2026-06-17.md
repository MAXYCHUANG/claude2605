...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| NVDA | 核心 AI call momentum | 207.41 | -12.3% | 0.539 | 0.774 | 35.8% | NA | NA | NA | NA |  |
| TSM | 核心供應鏈高位避險 | 425.83 | -5.4% | 4.150 | 1.705 | 49.2% | NA | NA | NA | NA | 警示：PCR volume > 1.5，短線 put demand 明顯<br>警示：PCR OI > 1.5，存量避險或 bearish 部位偏重 |
| SMH | 半導體 ETF 高位避險 | 616.00 | -5.1% | 4.321 | 3.057 | 51.8% | NA | NA | NA | NA | 警示：IV >= 45%，波動偏高<br>警示：PCR volume > 1.5，短線 put demand 明顯<br>警示：PCR OI > 1.5，存量避險或 bearish 部位偏重 |
| AMD | Momentum + call exposure | 507.29 | -9.1% | 1.233 | 0.872 | 70.1% | NA | NA | NA | NA | 警示：IV >= 60%，波動偏高 |
| INTC | 高風險轉機 squeeze | 117.05 | -11.8% | 0.377 | 0.911 | 83.8% | NA | NA | NA | NA | 警示：IV >= 80%，市場定價極高波動 |
| MU | 強基本面 + peak-cycle 疑慮 | 1020.76 | -8.1% | 1.578 | 2.448 | 105.0% | NA | NA | NA | NA | 警示：IV >= 80%，市場定價極高波動<br>警示：PCR volume > 1.5，短線 put demand 明顯<br>警示：PCR OI > 1.5，存量避險或 bearish 部位偏重 |
