...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| NVDA | 核心 AI call momentum | 211.14 | NA | 0.212 | 0.673 | 40.5% | NA | NA | NA | NA | 警示：call crowding，追漲部位擁擠 |
| TSM | 核心供應鏈高位避險 | 418.45 | NA | 2.679 | 2.175 | 42.8% | NA | NA | NA | NA | 警示：PCR volume > 1.5，短線 put demand 明顯<br>警示：PCR OI > 1.5，存量避險或 bearish 部位偏重 |
| SMH | 半導體 ETF 高位避險 | 598.93 | NA | 2.084 | 3.432 | 47.4% | NA | NA | NA | NA | 警示：IV >= 45%，波動偏高<br>警示：PCR volume > 1.5，短線 put demand 明顯<br>警示：PCR OI > 1.5，存量避險或 bearish 部位偏重 |
| AMD | Momentum + call exposure | 516.10 | NA | 1.266 | 0.943 | 69.2% | NA | NA | NA | NA | 警示：IV >= 60%，波動偏高 |
| INTC | 高風險轉機 squeeze | 114.68 | NA | 0.745 | 1.569 | 80.0% | NA | NA | NA | NA | 警示：IV >= 80%，市場定價極高波動<br>警示：PCR OI > 1.5，存量避險或 bearish 部位偏重 |
| MU | 強基本面 + peak-cycle 疑慮 | 971.00 | NA | 2.939 | 1.171 | 103.8% | NA | NA | NA | NA | 警示：IV >= 80%，市場定價極高波動<br>警示：PCR volume > 1.5，短線 put demand 明顯 |

## 3. Futures / ETF Context

| 標的 | 價格 | 日變化 | 52 週高 | 資料源 |
|---|---:|---:|---:|---|
| QQQ | 738.31 | 0.06% | NA | Stooq |
| SOXX | 569.08 | -1.28% | NA | Stooq |
| NQ=F | NA | NA | NA | Yahoo |
| ES=F | NA | NA | NA | Yahoo |
| ^VIX | NA | NA | NA | Yahoo |
