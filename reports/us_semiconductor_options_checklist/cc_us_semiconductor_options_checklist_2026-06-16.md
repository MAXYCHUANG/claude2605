...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| NVDA | 核心 AI call momentum | 212.45 | -10.2% | 0.481 | 0.777 | 36.6% | NA | NA | NA | NA |  |
| TSM | 核心供應鏈高位避險 | 441.40 | -1.9% | 1.276 | 1.781 | 49.5% | NA | NA | NA | NA | 警示：PCR OI > 1.5，存量避險或 bearish 部位偏重<br>警示：接近 52 週高且 PCR OI > 1，高位避險累積 |
| SMH | 半導體 ETF 高位避險 | 647.10 | -0.3% | 11.863 | 2.680 | 50.0% | NA | NA | NA | NA | 警示：IV >= 45%，波動偏高<br>警示：PCR volume > 1.5，短線 put demand 明顯<br>警示：PCR OI > 1.5，存量避險或 bearish 部位偏重<br>警示：接近 52 週高且 PCR OI > 1，高位避險累積 |
| AMD | Momentum + call exposure | 547.26 | -2.0% | 1.055 | 0.962 | 73.5% | NA | NA | NA | NA | 警示：IV >= 60%，波動偏高 |
| INTC | 高風險轉機 squeeze | 127.86 | -3.7% | 0.541 | 0.916 | 85.7% | NA | NA | NA | NA | 警示：IV >= 80%，市場定價極高波動 |
| MU | 強基本面 + peak-cycle 疑慮 | 1087.99 | -0.9% | 0.774 | 3.769 | 107.6% | NA | NA | NA | NA | 警示：IV >= 80%，市場定價極高波動<br>警示：PCR OI > 1.5，存量避險或 bearish 部位偏重<br>警示：接近 52 週高且 PCR OI > 1，高位避險累積 |
