...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| NVDA | 核心 AI call momentum | 224.36 | NA | 0.338 | 0.659 | 41.6% | NA | NA | NA | NA | 警示：call crowding，追漲部位擁擠 |
| TSM | 核心供應鏈高位避險 | 435.63 | NA | 0.583 | 2.384 | 48.0% | NA | NA | NA | NA | 警示：PCR OI > 1.5，存量避險或 bearish 部位偏重 |
| SMH | 半導體 ETF 高位避險 | 607.81 | NA | 5.055 | 2.287 | 49.5% | NA | NA | NA | NA | 警示：IV >= 45%，波動偏高<br>警示：PCR volume > 1.5，短線 put demand 明顯<br>警示：PCR OI > 1.5，存量避險或 bearish 部位偏重 |
| AMD | Momentum + call exposure | 510.13 | NA | 0.778 | 1.222 | 70.0% | NA | NA | NA | NA | 警示：IV >= 60%，波動偏高 |
| INTC | 高風險轉機 squeeze | 109.33 | NA | 1.606 | 1.654 | 82.9% | NA | NA | NA | NA | 警示：IV >= 80%，市場定價極高波動<br>警示：PCR volume > 1.5，短線 put demand 明顯<br>警示：PCR OI > 1.5，存量避險或 bearish 部位偏重 |
| MU | 強基本面 + peak-cycle 疑慮 | 1035.50 | NA | 0.720 | 1.921 | 102.8% | NA | NA | NA | NA | 警示：IV >= 80%，市場定價極高波動<br>警示：PCR OI > 1.5，存量避險或 bearish 部位偏重 |

## 3. Futures / ETF Context

| 標的 | 價格 | 日變化 | 52 週高 | 資料源 |
|---|---:|---:|---:|---|
| QQQ | 742.74 | 0.77% | NA | Stooq |
| SOXX | 571.93 | 1.47% | NA | Stooq |
| NQ=F | NA | NA | NA | Yahoo |
| ES=F | NA | NA | NA | Yahoo |
| ^VIX | NA | NA | NA | Yahoo |
