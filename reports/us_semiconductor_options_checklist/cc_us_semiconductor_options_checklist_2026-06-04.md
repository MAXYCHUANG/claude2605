...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| NVDA | 核心 AI call momentum | 214.75 | NA | 0.453 | 0.576 | 40.0% | NA | NA | NA | NA | 警示：call crowding，追漲部位擁擠 |
| TSM | 核心供應鏈高位避險 | 436.69 | NA | 0.493 | 1.422 | 46.1% | NA | NA | NA | NA |  |
| SMH | 半導體 ETF 高位避險 | 637.90 | NA | 3.266 | 4.015 | 50.2% | NA | NA | NA | NA | 警示：IV >= 45%，波動偏高<br>警示：PCR volume > 1.5，短線 put demand 明顯<br>警示：PCR OI > 1.5，存量避險或 bearish 部位偏重 |
| AMD | Momentum + call exposure | 542.52 | NA | 0.463 | 1.059 | 70.8% | NA | NA | NA | NA | 警示：IV >= 60%，波動偏高 |
| INTC | 高風險轉機 squeeze | 112.71 | NA | 0.509 | 1.767 | 80.9% | NA | NA | NA | NA | 警示：IV >= 80%，市場定價極高波動<br>警示：PCR OI > 1.5，存量避險或 bearish 部位偏重 |
| MU | 強基本面 + peak-cycle 疑慮 | 1079.57 | NA | 0.786 | 2.965 | 101.8% | NA | NA | NA | NA | 警示：IV >= 80%，市場定價極高波動<br>警示：PCR OI > 1.5，存量避險或 bearish 部位偏重 |

## 3. Futures / ETF Context

| 標的 | 價格 | 日變化 | 52 週高 | 資料源 |
|---|---:|---:|---:|---|
| QQQ | 744.21 | -0.41% | NA | Stooq |
| SOXX | 615.68 | -0.09% | NA | Stooq |
| NQ=F | NA | NA | NA | Yahoo |
| ES=F | NA | NA | NA | Yahoo |
| ^VIX | NA | NA | NA | Yahoo |
