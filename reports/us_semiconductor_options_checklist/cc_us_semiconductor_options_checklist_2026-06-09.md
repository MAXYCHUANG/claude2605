...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| NVDA | 核心 AI call momentum | 208.64 | -11.8% | 0.451 | 0.893 | 39.5% | NA | NA | NA | NA |  |
| TSM | 核心供應鏈高位避險 | 426.80 | -5.2% | 0.290 | 1.698 | 47.1% | NA | NA | NA | NA | 警示：PCR OI > 1.5，存量避險或 bearish 部位偏重 |
| SMH | 半導體 ETF 高位避險 | 598.16 | -6.9% | 1.255 | 2.416 | 51.5% | NA | NA | NA | NA | 警示：IV >= 45%，波動偏高<br>警示：PCR OI > 1.5，存量避險或 bearish 部位偏重 |
| AMD | Momentum + call exposure | 490.33 | -10.3% | 0.697 | 1.496 | 71.0% | NA | NA | NA | NA | 警示：IV >= 60%，波動偏高 |
| INTC | 高風險轉機 squeeze | 110.27 | -16.9% | 0.342 | 1.173 | 82.7% | NA | NA | NA | NA | 警示：IV >= 80%，市場定價極高波動 |
| MU | 強基本面 + peak-cycle 疑慮 | 949.28 | -12.9% | 0.930 | 12.759 | 103.5% | NA | NA | NA | NA | 警示：IV >= 80%，市場定價極高波動<br>警示：PCR OI > 1.5，存量避險或 bearish 部位偏重 |
