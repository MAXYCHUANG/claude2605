...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| NVDA | 核心 AI call momentum | 220.61 | NA | 0.684 | 0.892 | 45.2% | NA | NA | NA | NA |  |
| TSM | 核心供應鏈高位避險 | 392.61 | NA | 2.743 | 1.194 | 44.6% | NA | NA | NA | NA | 警示：PCR volume > 1.5，短線 put demand 明顯 |
| SMH | 半導體 ETF 高位避險 | 543.96 | NA | 2.491 | 2.727 | 46.1% | NA | NA | NA | NA | 警示：IV >= 45%，波動偏高<br>警示：PCR volume > 1.5，短線 put demand 明顯<br>警示：PCR OI > 1.5，存量避險或 bearish 部位偏重 |
| AMD | Momentum + call exposure | 414.05 | NA | 0.586 | 1.034 | 67.1% | NA | NA | NA | NA | 警示：IV >= 60%，波動偏高 |
| INTC | 高風險轉機 squeeze | 110.80 | NA | 0.705 | 1.149 | 83.4% | NA | NA | NA | NA | 警示：IV >= 80%，市場定價極高波動 |
| MU | 強基本面 + peak-cycle 疑慮 | 698.74 | NA | 0.509 | 1.391 | 87.8% | NA | NA | NA | NA | 警示：IV >= 80%，市場定價極高波動 |

## 3. Futures / ETF Context

| 標的 | 價格 | 日變化 | 52 週高 | 資料源 |
|---|---:|---:|---:|---|
| QQQ | 701.53 | 0.25% | NA | Stooq |
| SOXX | 496.74 | 2.55% | NA | Stooq |
| NQ=F | NA | NA | NA | Yahoo |
| ES=F | NA | NA | NA | Yahoo |
| ^VIX | NA | NA | NA | Yahoo |
