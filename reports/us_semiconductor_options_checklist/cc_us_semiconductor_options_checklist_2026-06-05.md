...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| NVDA | 核心 AI call momentum | 218.66 | NA | 0.522 | 0.621 | 38.6% | NA | NA | NA | NA |  |
| TSM | 核心供應鏈高位避險 | 444.92 | NA | 0.809 | 1.285 | 44.2% | NA | NA | NA | NA |  |
| SMH | 半導體 ETF 高位避險 | 627.53 | NA | 2.663 | 5.116 | 48.3% | NA | NA | NA | NA | 警示：IV >= 45%，波動偏高<br>警示：PCR volume > 1.5，短線 put demand 明顯<br>警示：PCR OI > 1.5，存量避險或 bearish 部位偏重 |
| AMD | Momentum + call exposure | 523.20 | NA | 1.102 | 0.993 | 68.8% | NA | NA | NA | NA | 警示：IV >= 60%，波動偏高 |
| INTC | 高風險轉機 squeeze | 111.78 | NA | 0.933 | 1.575 | 76.2% | NA | NA | NA | NA | 警示：IV >= 60%，波動偏高<br>警示：PCR OI > 1.5，存量避險或 bearish 部位偏重 |
| MU | 強基本面 + peak-cycle 疑慮 | 996.00 | NA | 0.850 | 3.434 | 99.9% | NA | NA | NA | NA | 警示：IV >= 80%，市場定價極高波動<br>警示：PCR OI > 1.5，存量避險或 bearish 部位偏重 |

## 3. Futures / ETF Context

| 標的 | 價格 | 日變化 | 52 週高 | 資料源 |
|---|---:|---:|---:|---|
| QQQ | 740.61 | 0.70% | NA | Stooq |
| SOXX | 602.72 | 2.57% | NA | Stooq |
| NQ=F | NA | NA | NA | Yahoo |
| ES=F | NA | NA | NA | Yahoo |
| ^VIX | NA | NA | NA | Yahoo |
