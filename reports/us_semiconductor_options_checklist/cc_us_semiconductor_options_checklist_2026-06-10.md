...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| NVDA | 核心 AI call momentum | 208.19 | -12.0% | 0.525 | 0.787 | 39.6% | NA | NA | NA | NA |  |
| TSM | 核心供應鏈高位避險 | 427.92 | -4.9% | 2.811 | 1.524 | 48.8% | NA | NA | NA | NA | 警示：PCR volume > 1.5，短線 put demand 明顯<br>警示：PCR OI > 1.5，存量避險或 bearish 部位偏重<br>警示：接近 52 週高且 PCR OI > 1，高位避險累積 |
| SMH | 半導體 ETF 高位避險 | 591.01 | -8.1% | 0.886 | 1.900 | 53.3% | NA | NA | NA | NA | 警示：IV >= 45%，波動偏高<br>警示：PCR OI > 1.5，存量避險或 bearish 部位偏重 |
| AMD | Momentum + call exposure | 475.50 | -13.0% | 1.787 | 1.218 | 70.5% | NA | NA | NA | NA | 警示：IV >= 60%，波動偏高<br>警示：PCR volume > 1.5，短線 put demand 明顯 |
| INTC | 高風險轉機 squeeze | 107.92 | -18.7% | 0.749 | 0.843 | 83.9% | NA | NA | NA | NA | 警示：IV >= 80%，市場定價極高波動 |
| MU | 強基本面 + peak-cycle 疑慮 | 935.89 | -14.1% | 0.551 | 13.152 | 103.1% | NA | NA | NA | NA | 警示：IV >= 80%，市場定價極高波動<br>警示：PCR OI > 1.5，存量避險或 bearish 部位偏重 |
