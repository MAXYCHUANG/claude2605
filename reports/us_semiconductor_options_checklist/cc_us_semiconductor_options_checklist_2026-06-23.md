...
|---|---|---:|---:|---:|---:|---:|---|
| NVDA | 核心 AI call momentum | 208.65 | -11.5% | 0.391 | 0.641 | 35.2% | 警示：call crowding，追漲部位擁擠 |
| TSM | 核心供應鏈高位避險 | 467.67 | 0.0% | 3.034 | 1.834 | 51.6% | 警示：PCR volume > 1.5，短線 put demand 明顯<br>警示：PCR OI > 1.5，存量避險或 bearish 部位偏重<br>警示：接近 52 週高且 PCR OI > 1，高位避險累積 |
| SMH | 半導體 ETF 高位避險 | 668.91 | 0.0% | 2.417 | 3.187 | 55.0% | 警示：IV >= 45%，波動偏高<br>警示：PCR volume > 1.5，短線 put demand 明顯<br>警示：PCR OI > 1.5，存量避險或 bearish 部位偏重<br>警示：接近 52 週高且 PCR OI > 1，高位避險累積 |
| AMD | Momentum + call exposure | 551.63 | 0.0% | 0.648 | 0.926 | 73.5% | 警示：IV >= 60%，波動偏高 |
| INTC | 高風險轉機 squeeze | 140.94 | 0.0% | 0.854 | 0.699 | 95.6% | 警示：IV >= 80%，市場定價極高波動 |
| MU | 強基本面 + peak-cycle 疑慮 | 1211.38 | 0.0% | 0.813 | 2.052 | 107.3% | 警示：IV >= 80%，市場定價極高波動<br>警示：PCR OI > 1.5，存量避險或 bearish 部位偏重<br>警示：接近 52 週高且 PCR OI > 1，高位避險累積 |

## 3. Futures / ETF Context

| 標的 | 價格 | 日變化 | 52 週高 | 資料源 |
|---|---:|---:|---:|---|
| QQQ | 737.95 | -0.55% | 746.16 | Yahoo chart |
| SOXX | 655.01 | 0.16% | 655.01 | Yahoo chart |
| NQ=F | 29796.75 | -2.82% | 30712.75 | Yahoo chart |
| ES=F | 7441.25 | -1.33% | 7623.75 | Yahoo chart |
| ^VIX | 17.28 | -1.14% | 31.05 | CBOE |

## 4. 警示

警示：NQ futures 下跌超過 1.5%，科技股 beta 壓力升高
