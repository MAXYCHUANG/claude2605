...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| NVDA | 核心 AI call momentum | 205.10 | NA | 1.517 | 0.665 | 42.0% | NA | NA | NA | NA | 警示：PCR volume > 1.5，短線 put demand 明顯 |
| TSM | 核心供應鏈高位避險 | 415.17 | NA | 1.710 | 1.263 | 46.4% | NA | NA | NA | NA | 警示：PCR volume > 1.5，短線 put demand 明顯 |
| SMH | 半導體 ETF 高位避險 | 569.69 | NA | 2.421 | 3.703 | 51.7% | NA | NA | NA | NA | 警示：IV >= 45%，波動偏高<br>警示：PCR volume > 1.5，短線 put demand 明顯<br>警示：PCR OI > 1.5，存量避險或 bearish 部位偏重 |
| AMD | Momentum + call exposure | 466.38 | NA | 3.477 | 1.022 | 70.1% | NA | NA | NA | NA | 警示：IV >= 60%，波動偏高<br>警示：PCR volume > 1.5，短線 put demand 明顯 |
| INTC | 高風險轉機 squeeze | 99.17 | NA | 0.711 | 1.508 | 81.6% | NA | NA | NA | NA | 警示：IV >= 80%，市場定價極高波動<br>警示：PCR OI > 1.5，存量避險或 bearish 部位偏重 |
| MU | 強基本面 + peak-cycle 疑慮 | 864.01 | NA | 7.191 | 3.709 | 104.4% | NA | NA | NA | NA | 警示：IV >= 80%，市場定價極高波動<br>警示：PCR volume > 1.5，短線 put demand 明顯<br>警示：PCR OI > 1.5，存量避險或 bearish 部位偏重 |
...
- NVDA: 警示：PCR volume > 1.5，短線 put demand 明顯
...
- MU: 警示：PCR volume > 1.5，短線 put demand 明顯
- MU: 警示：PCR OI > 1.5，存量避險或 bearish 部位偏重

## 5. 資料缺口

- NVDA: price unavailable
