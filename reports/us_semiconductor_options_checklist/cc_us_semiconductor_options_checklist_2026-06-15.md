...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| NVDA | 核心 AI call momentum | 205.19 | -13.3% | 0.513 | 0.768 | 37.1% | NA | NA | NA | NA |  |
| TSM | 核心供應鏈高位避險 | 423.93 | -5.8% | 1.463 | 1.716 | 46.9% | NA | NA | NA | NA | 警示：PCR OI > 1.5，存量避險或 bearish 部位偏重 |
| SMH | 半導體 ETF 高位避險 | 619.96 | -3.5% | 1.008 | 1.836 | 53.1% | NA | NA | NA | NA | 警示：IV >= 45%，波動偏高<br>警示：PCR OI > 1.5，存量避險或 bearish 部位偏重<br>警示：接近 52 週高且 PCR OI > 1，高位避險累積 |
| AMD | Momentum + call exposure | 511.57 | -6.4% | 1.233 | 1.100 | 72.5% | NA | NA | NA | NA | 警示：IV >= 60%，波動偏高 |
| INTC | 高風險轉機 squeeze | 124.57 | -6.2% | 0.779 | 0.825 | 87.6% | NA | NA | NA | NA | 警示：IV >= 80%，市場定價極高波動 |
| MU | 強基本面 + peak-cycle 疑慮 | 981.61 | -9.9% | 2.913 | 7.729 | 106.3% | NA | NA | NA | NA | 警示：IV >= 80%，市場定價極高波動<br>警示：PCR volume > 1.5，短線 put demand 明顯<br>警示：PCR OI > 1.5，存量避險或 bearish 部位偏重 |
