...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| NVDA | 核心 AI call momentum | 214.25 | NA | 0.550 | 0.582 | 37.8% | NA | NA | NA | NA |  |
| TSM | 核心供應鏈高位避險 | 424.86 | NA | 0.555 | 3.059 | 44.1% | NA | NA | NA | NA | 警示：PCR OI > 1.5，存量避險或 bearish 部位偏重 |
| SMH | 半導體 ETF 高位避險 | 599.83 | NA | 2.645 | 3.789 | 46.5% | NA | NA | NA | NA | 警示：IV >= 45%，波動偏高<br>警示：PCR volume > 1.5，短線 put demand 明顯<br>警示：PCR OI > 1.5，存量避險或 bearish 部位偏重 |
| AMD | Momentum + call exposure | 518.09 | NA | 0.882 | 0.897 | 70.1% | NA | NA | NA | NA | 警示：IV >= 60%，波動偏高 |
| INTC | 高風險轉機 squeeze | 120.89 | NA | 3.270 | 1.203 | 79.5% | NA | NA | NA | NA | 警示：IV >= 60%，波動偏高<br>警示：PCR volume > 1.5，短線 put demand 明顯 |
| MU | 強基本面 + peak-cycle 疑慮 | 923.52 | NA | 1.123 | 1.178 | 99.0% | NA | NA | NA | NA | 警示：IV >= 80%，市場定價極高波動 |

## 3. Futures / ETF Context

| 標的 | 價格 | 日變化 | 52 週高 | 資料源 |
|---|---:|---:|---:|---|
| QQQ | 735.60 | 0.80% | NA | Stooq |
| SOXX | 569.47 | 0.91% | NA | Stooq |
| NQ=F | NA | NA | NA | Yahoo |
| ES=F | NA | NA | NA | Yahoo |
| ^VIX | NA | NA | NA | Yahoo |
