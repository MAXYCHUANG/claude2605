...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| NVDA | 核心 AI call momentum | 222.32 | NA | 0.644 | 0.783 | 46.2% | NA | NA | NA | NA |  |
| TSM | 核心供應鏈高位避險 | 395.95 | NA | 2.322 | 1.482 | 44.1% | NA | NA | NA | NA | 警示：PCR volume > 1.5，短線 put demand 明顯 |
| SMH | 半導體 ETF 高位避險 | 546.16 | NA | 1.360 | 2.403 | 46.2% | NA | NA | NA | NA | 警示：IV >= 45%，波動偏高<br>警示：PCR OI > 1.5，存量避險或 bearish 部位偏重 |
| AMD | Momentum + call exposure | 420.99 | NA | 0.808 | 1.054 | 66.6% | NA | NA | NA | NA | 警示：IV >= 60%，波動偏高 |
| INTC | 高風險轉機 squeeze | 108.17 | NA | 0.679 | 1.164 | 81.2% | NA | NA | NA | NA | 警示：IV >= 80%，市場定價極高波動 |
| MU | 強基本面 + peak-cycle 疑慮 | 681.54 | NA | 0.657 | 1.669 | 88.8% | NA | NA | NA | NA | 警示：IV >= 80%，市場定價極高波動<br>警示：PCR OI > 1.5，存量避險或 bearish 部位偏重 |

## 3. Futures / ETF Context

| 標的 | 價格 | 日變化 | 52 週高 | 資料源 |
|---|---:|---:|---:|---|
| QQQ | 705.88 | -0.80% | NA | Stooq |
| SOXX | 495.87 | -4.27% | NA | Stooq |
| NQ=F | NA | NA | NA | Yahoo |
| ES=F | NA | NA | NA | Yahoo |
| ^VIX | NA | NA | NA | Yahoo |
